// -----------------------------------------------------------------------
// <copyright file="Int3ValueTests.cs" company="MagicKitchen">
...
namespace MagicKitchen.SplitterSprite4.Common.Test.Spec.Indexer.Dict.Value
{
    ...
    public class Int3ValueTests
    {
        ...
        public void GetterTest(string path)
        {
            ...
            var dict = spec.Dict.Keyword.Int3["dict"];
        ...
        public void SetterTest(string path)
        {
            ...
            // act
            var spec = SpecRoot.Fetch(proxy, agnosticPath);
            spec.Dict.Keyword.Int3["dict"] = new Dictionary<string, (int, int, int)>
            {
                { "zero-zero-one", (0, 0, 1) },
                { "zero-one-zero", (0, 1, 0) },
                { "one-zero-zero", (1, 0, 0) },
