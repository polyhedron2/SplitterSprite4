// -----------------------------------------------------------------------
// <copyright file="RangeKeyTests.cs" company="MagicKitchen">
...
namespace MagicKitchen.SplitterSprite4.Common.Test.Spec.Indexer.Dict
{
    ...
    public class RangeKeyTests
    {
        ...
        public void GetterTest(string path)
        {
            ...
            var dict = spec.Dict.Range(5).Keyword["dict"];
        ...
        public void InvalidKeyGetterTest(string path)
        {
            ...
            {
                _ = spec.Dict.Range(5).Keyword["dict"];
            });
        }
        ...
        public void SetterTest(string path)
        {
            ...
            // act
            var spec = SpecRoot.Fetch(proxy, agnosticPath);
            spec.Dict.Range(5).Keyword["dict"] = new Dictionary<int, string>
            {
                { 0, "zero" },
                { 2, "two" },
                { 4, "four" },
